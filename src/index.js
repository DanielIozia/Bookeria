...
function searchBooks(event) {
    ...
    try{
        ...
        errorMessage.innerHTML = "An error occurred while searching for books.<br>Please try again later.";
    }
}
...
function showDescription(bookKey, authorName) {
    ...
    try{
        ...
        console.error('Error in showDescription:', err);
        errorMessage.innerHTML = "An error occurred while searching for description.<br>Please try again later.";
    }
}
